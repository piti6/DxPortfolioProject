...
void CCharacterObject::Animate(float fTimeElapsed, PxScene *pPxScene)
{
	...
	D3DXVECTOR3 LookVector = GetLookAt();
	m_pPxCharacterController->move(PxVec3(LookVector.x, LookVector.y-9.8f, LookVector.z) * fTimeElapsed, 0, fTimeElapsed, PxControllerFilters());
